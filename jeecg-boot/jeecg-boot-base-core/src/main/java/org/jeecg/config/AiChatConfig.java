...
public class AiChatConfig {
    ...
    public static class ModelConfig {
        ...
        /**
         * API版本号（如 Anthropic 的 anthropic-version: 2023-06-01）
         */
        private String apiVersion;
        /**
         * 组织ID（如 OpenAI 的 OpenAI-Organization header）
         */
        private String organization;
        /**
         * 自定义请求头（JSON格式，如 {"X-Custom-Header": "value"}）
         */
        private String customHeaders;
        /**
         * 用户标识（OpenAI 的 user 参数，用于滥用监控）
         */
        private String user;
    }
