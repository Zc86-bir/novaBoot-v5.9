...
<script lang="ts" setup>
  ...
  import ConversationSettingsModal from '/@/views/super/airag/aiapp/chat/components/ConversationSettingsModal.vue';
  ...
  // 处理设置保存
  function handleSettingsOk(settings) {
    // 更新当前会话的设置
    conversationSettings.value[uuid.value] = {
      ...conversationSettings.value[uuid.value],
      ...settings,
    };
  }
